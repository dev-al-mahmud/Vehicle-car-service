! function(e) {
    ...
    class t extends elementorModules.frontend.handlers.Base {
        getDefaultSettings() {
            return {
                selectors: {
                    ...
                    close_toggle: '.jkit-close-menu, .menu-item:not(.menu-item-has-children, .has-mega-menu) a[href^="#"]',
                    dropdown_toggle: "li.menu-item-has-children > a i, li.menu-item-has-children > a svg",
                    menu_dropdown: "li.menu-item-has-children > a, li.has-mega-menu > a"
                }
            }
        }
        getDefaultElements() {
        ...
        bindEvents() {
            const e = this;
            e.onLoadElement(), jQuery(window).on("resize", (function() {
                e.megamenu()
            }))
        }
        onLoadElement() {
            this.addBodyClass(), this.addDropdownIcon(), this.addHoverGradient(), this.onToogleClick(), this.megamenu()
        }
        addBodyClass() {
            this.elements.$wrapper.length > 0 && jQuery("body").addClass("jkit-nav-menu-loaded")
        }
        addHoverGradient() {
        ...
        addDropdownIcon() {
            ...
            })), this.elements.$dropdown_toggle = this.$element.find(t.dropdown_toggle)
        }
        onToogleClick() {
            const e = this,
            ...
            o.on("click", (function(n) {
                n.preventDefault(), e.elements.$container.hasClass("active") ? e.elements.$container.removeClass("active") : e.elements.$container.addClass("active")
            })), r.on("click", (function(n) {
                n.preventDefault(), e.elements.$container.removeClass("active")
            })), n.hasClass("submenu-click-title") ? t.each((function() {
                jQuery(this).on("click", (function(e) {
                    const t = jQuery(window).width();
                    if (n.hasClass("break-point-tablet") && t > 1024 || n.hasClass("break-point-mobile") && t > 768) return;
                    e.preventDefault();
                    const o = jQuery(this).parent(".menu-item").find("> .sub-menu, > .jkit-mega-menu-wrapper");
                    o.hasClass("dropdown-open") ? o.removeClass("dropdown-open") : o.addClass("dropdown-open")
                }))
            })) : i.each((function() {
                jQuery(this).on("click", (function(e) {
                    e.preventDefault();
                    const n = jQuery(this).parent().parent(".menu-item").find("> .sub-menu, .jkit-mega-menu-wrapper");
                    n.hasClass("dropdown-open") ? n.removeClass("dropdown-open") : n.addClass("dropdown-open")
                }))
            }))
        }
        megamenu() {
    ...
    jQuery(window).on("elementor/frontend/init", (() => {
        elementorFrontend.hooks.addAction("frontend/element_ready/jkit_nav_menu.default", (e => {
